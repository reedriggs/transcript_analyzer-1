...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  5 08:53:38 2021
...
conc_sort_1 = sorted(concord_1, key = lambda x: x[1]) #sort alphabetically by the target item (x[1])
conc_sort_2 = sorted(concord_2, key = lambda x: x[1]) #sort alphabetically by the target item (x[1])

print(f"This is the raw concondancing of \"{target_1}\" from file 1 ({str(nleft)} words before and {str(nright)} words after):")
print(concord_1)
print("\n" + "\n" + "\n")
print(f"This is the raw concondancing of \"{target_2}\" from file 2 ({str(nleft)} words before and {str(nright)} words after):")
print(concord_2)
print("\n" + "\n" + "\n")
print(f"This is an alphabetically sorted concondancing of \"{target_1}\" from file 1 ({str(nleft)} words before and {str(nright)} words after):")
for x in conc_sort_1:
	print(x)
print("\n" + "\n" + "\n")
print(f"This is an alphabetically sorted concondancing of \"{target_2}\" from file 2 ({str(nleft)} words before and {str(nright)} words after):")
for x in conc_sort_2:
	print(x)
